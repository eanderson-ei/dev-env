...
Modified to rank named entities instead of words
"""
...
class TextRank4Keyword():
    ...
    def sentence_segment(self, doc, not_entity_types, lower):
        ...
        for sent in doc.sents:
            ...
            for entity in sent.ents:  # entities instead of words
                ...
                if entity.label_ not in not_entity_types:
                    if lower is True:
                        selected_words.append(entity.text.lower())
                    else:
                        selected_words.append(entity.text)
